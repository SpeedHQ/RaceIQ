...
- Added finite non-negative validation for median, p99, and retained-heap thresholds.

## Verification

- `bun test test/tooling/bench-compare.test.ts --timeout 60000`: 10 pass, 0 fail.
...
- Review follow-up threshold validation rerun: 10 pass, 0 fail.
