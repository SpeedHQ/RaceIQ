...
export const developmentReleaseFeatures = releaseFeatureFlags({
  ...
  RACEIQ_FEATURE_LIVE_SPOTTER_ENGINEER: values.get("RACEIQ_FEATURE_LIVE_SPOTTER_ENGINEER"),
  RACEIQ_FEATURE_LIVE_SPOTTER_ENGINEER_GAME_IDS: values.get("RACEIQ_FEATURE_LIVE_SPOTTER_ENGINEER_GAME_IDS"),
});
