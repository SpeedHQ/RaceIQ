 ...
 *
 * Usage:
 *   bun run scripts/games/ac-evo/extract-tracks.ts [kspkg]        # read track list from content.kspkg, append new rows
 *   bun run scripts/games/ac-evo/extract-tracks.ts --recordings   # scan .bin recordings, report known/unknown tracks
 *
...
import { extractAcEvoTrackGeometry } from "./extract-track-geometry";

const REPO_ROOT = resolve(import.meta.dir, "../../..");
const RECORDINGS_DIR = resolve(REPO_ROOT, "test", "artifacts", "sessions");
const CSV_PATH = resolve(REPO_ROOT, "shared", "games", "ac-evo", "tracks.csv");
const V2_HEADER = 16;
