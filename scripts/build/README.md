...
| `bun scripts/build/copy-shared-data.ts` | Copy runtime data/assets and `credstore.ps1`; exclude track venue/revision/layout manifests, registry report/source, and detector hints while retaining revision imagery, layout assets, and root shared geometry. |
