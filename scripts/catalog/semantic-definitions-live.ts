...
const SEMANTIC_DEFINITIONS_LIVE: Record<string, SemanticDefinition> = {
  ...
  "tires.blistering": {
    label: "Tire blistering",
    description: "Tire blistering percentage, FL/FR/RL/RR.",
    parentId: "tires",
    canonicalUnit: "%",
    shape: "per-wheel",
  ...
  "brakes.abs-active": {
    label: "ABS active",
    description: "Whether anti-lock braking is currently intervening.",
    parentId: "brakes",
    canonicalUnit: "boolean",
    shape: "scalar",
  },
  ...
  "engine.torque": {
    label: "Torque",
    description: "Current engine or driveline torque.",
    parentId: "engine",
    canonicalUnit: "N·m",
    shape: "scalar",
  },
  "engine.power": {
    label: "Power",
    description: "Current combined vehicle power output.",
    parentId: "engine",
    canonicalUnit: "W",
    shape: "scalar",
  },
  "engine.exhaust-temperature": {
    ...
    description: "Current engine exhaust-gas temperature.",
    parentId: "engine",
    canonicalUnit: "°C",
    shape: "scalar",
  },
  "engine.fuel-mixture": {
    label: "Fuel mixture",
    description: "Current driver-selected engine fuel mixture.",
    parentId: "engine",
    canonicalUnit: "enum",
    shape: "scalar",
    valueType: "enum",
    enumDomain: ["lean", "standard", "rich", "max"],
  },
  ...
  "fuel.capacity": {
    label: "Fuel capacity",
    description: "Usable fuel-tank capacity.",
    parentId: "fuel",
    canonicalUnit: "L",
    shape: "scalar",
  },
  "fuel.remaining-fraction": {
    label: "Fuel remaining fraction",
    description: "Fuel remaining as a fraction of usable capacity.",
    parentId: "fuel",
  ...
  "fuel.remaining-percent": {
    label: "Fuel remaining percent",
    description: "Fuel remaining as a percentage of usable capacity.",
    parentId: "fuel",
    canonicalUnit: "%",
    shape: "scalar",
    range: { min: 0, max: 100 },
  ...
  "fuel.used-volume": {
    label: "Fuel used volume",
    description: "Fuel volume consumed during the current session.",
    parentId: "fuel",
    canonicalUnit: "L",
    shape: "scalar",
  },
  "fuel.efficiency": {
    ...
    description: "Average distance traveled per liter of fuel.",
    parentId: "fuel",
    canonicalUnit: "km/L",
    shape: "scalar",
  },
  "fuel.instantaneous-efficiency": {
    label: "Instantaneous fuel efficiency",
    description: "Current distance-per-liter fuel-efficiency estimate.",
    parentId: "fuel",
    canonicalUnit: "km/L",
    shape: "scalar",
  },
  ...
  "inputs.throttle": {
    ...
    description: "Normalized accelerator input from fully released to fully applied.",
    parentId: "inputs",
    canonicalUnit: "ratio",
    shape: "scalar",
    range: { min: 0, max: 1 },
  ...
  "inputs.brake": {
    label: "Brake input",
    description: "Normalized brake input from fully released to fully applied.",
    parentId: "inputs",
    canonicalUnit: "ratio",
    shape: "scalar",
    range: { min: 0, max: 1 },
  ...
  "inputs.clutch": {
    label: "Clutch input",
    description: "Normalized clutch input from fully released to fully applied.",
    parentId: "inputs",
    canonicalUnit: "ratio",
    shape: "scalar",
    range: { min: 0, max: 1 },
  ...
  "inputs.handbrake": {
    label: "Handbrake input",
    description: "Normalized handbrake input from fully released to fully applied.",
    parentId: "inputs",
    canonicalUnit: "ratio",
    shape: "scalar",
    range: { min: 0, max: 1 },
  ...
  "inputs.steering": {
    ...
    description: "Normalized signed steering input from full left to full right.",
    parentId: "inputs",
    canonicalUnit: "ratio",
    shape: "scalar",
    range: { min: -1, max: 1 },
  ...
  "timing.session-time-remaining": {
    label: "Session time remaining",
    description: "Time remaining in the current session.",
    parentId: "timing",
    canonicalUnit: "s",
    shape: "scalar",
  },
  "timing.delta-to-reference": {
    label: "Delta to reference",
    description: "Signed time delta to the active reference lap or competitor.",
    parentId: "timing",
    canonicalUnit: "s",
    shape: "scalar",
  },
  "timing.gap-ahead": {
    label: "Gap ahead",
    description: "Time gap to the vehicle directly ahead.",
    parentId: "timing",
    canonicalUnit: "s",
    shape: "scalar",
  },
  "timing.gap-behind": {
    label: "Gap behind",
    description: "Time gap to the vehicle directly behind.",
    parentId: "timing",
    canonicalUnit: "s",
    shape: "scalar",
  },
  "timing.pit-lane-time-in-lane": {
    label: "Pit-lane time in lane",
    description: "Elapsed time spent in the pit lane during the current visit.",
    parentId: "timing",
    canonicalUnit: "s",
    shape: "scalar",
  },
  "timing.total-driving-time": {
    label: "Total driving time",
    description: "Total time the player has spent driving in the session.",
    parentId: "timing",
    canonicalUnit: "s",
    shape: "scalar",
  },
  "timing.time-of-day": {
    label: "Time of day",
    description: "Session time of day represented as elapsed seconds.",
    parentId: "timing",
    canonicalUnit: "s",
    shape: "scalar",
  },
  "session.timestamp": {
    ...
    description: "Source timestamp for the current telemetry frame.",
    parentId: "session",
    canonicalUnit: "s",
    shape: "scalar",
  },
