...
const SEMANTIC_DEFINITIONS_EXTENDED: Record<string, SemanticDefinition> = {
  ...
  "session.phase": semanticDefinition(
    "Session phase",
    "Normalized phase of the active session.",
    "session",
    "dimensionless",
    "scalar",
  ),
  "session.is-spectating": semanticDefinition(
    "Spectator state",
  ...
  "motion.competitor.position-x": semanticDefinition(
    "Competitor world position X",
    "World X position for each competitor.",
    "race.competitor.timing",
    "m",
    "structured",
  ),
  "motion.competitor.position-y": semanticDefinition(
    "Competitor world position Y",
    "World Y position for each competitor.",
    "race.competitor.timing",
    "m",
    "structured",
  ),
  "motion.competitor.position-z": semanticDefinition(
    "Competitor world position Z",
    "World Z position for each competitor.",
    "race.competitor.timing",
    "m",
    "structured",
  ),
  "motion.competitor.velocity-x": semanticDefinition(
    "Competitor velocity X",
    "World X velocity for each competitor.",
    "race.competitor.timing",
    "m/s",
    "structured",
  ),
  "motion.competitor.velocity-y": semanticDefinition(
    "Competitor velocity Y",
    "World Y velocity for each competitor.",
    "race.competitor.timing",
    "m/s",
    "structured",
  ),
  "motion.competitor.velocity-z": semanticDefinition(
    "Competitor velocity Z",
    "World Z velocity for each competitor.",
    "race.competitor.timing",
    "m/s",
    "structured",
  ),
  "motion.competitor.speed": semanticDefinition(
    "Competitor speed",
    "Ground speed for each competitor.",
    "race.competitor.timing",
    "m/s",
    "structured",
  ),
  "race.competitor.connected": semanticDefinition(
    "Competitor connectivity",
    "Whether each competitor is currently connected.",
    "race.competitor.results",
    "boolean",
    "structured",
  ),
  "engine.battery-voltage": semanticDefinition(
    "Battery voltage",
    "Source-provided traction battery voltage.",
    "engine",
    "V",
    "scalar",
  ),
  "engine.battery-state-of-charge": semanticDefinition(
    "Battery state of charge",
    "Normalized traction battery state of charge.",
    "engine",
    "ratio",
    "scalar",
  ),
  "timing.competitor.last-lap-valid": semanticDefinition(
    ...
    "Whether each competitor's last lap was valid.",
    "race.competitor.timing",
    "boolean",
    "structured",
  ),
