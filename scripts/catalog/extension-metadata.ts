...
"f1.grid[].lastLapValid": "timing.competitor.last-lap-valid",
  ...
  "f1.grid[].velY": "race.competitor.velocity-y",
  "f1.grid[].velZ": "race.competitor.velocity-z",
  "f1.grid[].speed": "race.competitor.speed",
  "f1.grid[].yaw": "race.competitor.yaw",
  ...
  "acc.broadcastPlayerCarIndex": "identity.player-car-index",
  "acc.broadcastPlayerCarClassId": "identity.player-car-class-id",
  "acc.broadcastSessionType": "session.session-type",
  "acc.broadcastPhase": "session.session-state",
  "acc.broadcastCarIndex": "race.competitor.car-index",
  "acc.broadcastDriverId": "race.competitor.driver-id",
  "acc.broadcastDriverName": "race.competitor.driver-name",
  ...
  "acc.broadcastPositionY": "motion.competitor.position-y",
  "acc.broadcastPositionZ": "motion.competitor.position-z",
  "acc.broadcastSpeed": "motion.competitor.speed",
  "acc.broadcastYaw": "motion.competitor.yaw",
  "acc.broadcastLastLapTime": "timing.competitor.last-lap-time",
  "acc.broadcastLastLapValid": "timing.competitor.last-lap-valid",
  "acc.broadcastConnected": "race.competitor.connected",
  "iracing.playerCarClassId": "identity.player-car-class-id",
  "iracing.sessionType": "session.session-type",
  "iracing.competitorCarIndex": "race.competitor.car-index",
  "iracing.competitorDriverId": "race.competitor.driver-id",
  "iracing.competitorDriverName": "race.competitor.driver-name",
  "iracing.competitorCarClassIdString": "race.competitor.car-class-id",
  "iracing.competitorCarClassName": "race.competitor.car-class-name",
  "iracing.competitorPitStatus": "race.competitor.pit-status",
  "iracing.competitorTrackLocationName": "race.competitor.track-location",
  "iracing.competitorLapsComplete": "race.competitor.laps-complete",
  "iracing.competitorLastLapTime": "timing.competitor.last-lap-time",
  ...
  "iracing.carIdxLap": "timing.competitor.current-lap-number",
  "iracing.carIdxBestLapTime": "timing.competitor.best-lap-time",
  "iracing.carLeftRight": "identity.car-left-right",
  "iracing.competitors[].carIndex": "race.competitor.car-index",
  "iracing.competitors[].userId": "race.competitor.driver-id",
  "iracing.competitors[].displayName": "race.competitor.driver-name",
  "iracing.competitors[].carClassId": "race.competitor.car-class-id",
  "iracing.competitors[].carClassShortName": "race.competitor.car-class-name",
  "iracing.competitors[].position": "race.competitor.position",
  "iracing.competitors[].classPosition": "race.competitor.class-position",
  "iracing.competitors[].lapsComplete": "race.competitor.laps-complete",
  "iracing.competitors[].onPitRoad": "race.competitor.pit-status",
...
const EXTENSION_METADATA: Record<string, Omit<ExtensionMetadata, "semanticId">> = {
  ...
  "acc.broadcastPhase": { unit: "count", description: "Native ACC broadcast lifecycle phase enum." },
  ...
  "iracing.competitors[].driverId": { unit: "id", description: "iRacing normalized competitor driver identifier.", kind: "normalized", normalization: "pass through canonical driver ID" },
  "iracing.competitors[].driverName": { unit: "text", description: "iRacing normalized competitor driver name.", kind: "normalized", normalization: "pass through canonical driver name" },
  "iracing.competitors[].carClassIdString": { unit: "id", description: "iRacing normalized competitor class identifier.", kind: "normalized", normalization: "pass through canonical class ID" },
  "iracing.competitors[].carClassName": { unit: "text", description: "iRacing normalized competitor class name.", kind: "normalized", normalization: "pass through canonical class name" },
  "iracing.competitors[].pitStatus": { unit: "enum", description: "iRacing normalized competitor pit status.", kind: "normalized", normalization: "pass through canonical pit status" },
  "iracing.competitors[].trackLocationName": { unit: "enum", description: "iRacing normalized competitor track location.", kind: "normalized", normalization: "pass through canonical track location" },
  "iracing.competitorCarIndex": { unit: "index", description: "iRacing car indexes aligned to joined competitor identities and timing.", kind: "normalized", normalization: "pass through joined competitor car indexes" },
  "iracing.competitorDriverId": { unit: "id", description: "iRacing canonical competitor driver IDs.", kind: "normalized", normalization: "pass through canonical driver IDs" },
  "iracing.competitorDriverName": { unit: "text", description: "iRacing canonical competitor driver names.", kind: "normalized", normalization: "pass through canonical driver names" },
  "iracing.competitorCarClassIdString": { unit: "id", description: "iRacing canonical competitor class IDs.", kind: "normalized", normalization: "pass through canonical class IDs" },
  "iracing.competitorCarClassName": { unit: "text", description: "iRacing canonical competitor class names.", kind: "normalized", normalization: "pass through canonical class names" },
  "iracing.competitorPitStatus": { unit: "enum", description: "iRacing canonical competitor pit statuses.", kind: "normalized", normalization: "pass through canonical pit statuses" },
  "iracing.competitorTrackLocationName": { unit: "enum", description: "iRacing canonical competitor track locations.", kind: "normalized", normalization: "pass through canonical track locations" },
  "iracing.competitorLapsComplete": { unit: "count", description: "iRacing completed laps aligned to joined competitor identities.", kind: "normalized", normalization: "pass through joined competitor completed laps" },
  "iracing.competitorLastLapTime": { unit: "s", description: "iRacing last lap seconds aligned to joined competitor identities.", kind: "normalized", normalization: "pass through joined competitor last lap times" },
