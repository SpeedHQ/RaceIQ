...
const EXTENSION_ALIASES: Record<string, string> = {
  ...
  "f1.fuelMix": "engine.fuel-mixture",
  ...
  "f1.pitLaneTimeInLaneInMS": "timing.pit-lane-time-in-lane",
  ...
  "f1.grid[].onPitRoad": "race.competitor.on-pit-road",
  ...
  "f1.tyreBlisters": "tires.blistering",
  ...
  "acc.acEvo.currentTorque": "engine.torque",
  "acc.acEvo.currentBhp": "engine.power",
  "acc.acEvo.exhaustTempC": "engine.exhaust-temperature",
  "acc.acEvo.clutchPercent": "inputs.clutch",
  "acc.acEvo.handbrakePercent": "inputs.handbrake",
  "acc.acEvo.fuelLiters": "fuel.remaining-volume",
  "acc.acEvo.fuelLitersPerLap": "fuel.fuel-per-lap",
  "acc.acEvo.fuelPercent": "fuel.remaining-percent",
  "acc.acEvo.fuelLitersUsed": "fuel.used-volume",
  "acc.acEvo.kmPerFuelLiter": "fuel.efficiency",
  "acc.acEvo.instantaneousKmPerLiter": "fuel.instantaneous-efficiency",
  ...
  "acc.acEvo.sessionTimeLeftMs": "timing.session-time-remaining",
  "acc.acEvo.deltaTimeMs": "timing.delta-to-reference",
  "acc.acEvo.gapAheadSeconds": "timing.gap-ahead",
  "acc.acEvo.gapBehindSeconds": "timing.gap-behind",
  ...
  "acc.acEvo.totalDrivingTimeS": "timing.total-driving-time",
  "acc.acEvo.timeOfDayHours": "timing.time-of-day",
  "acc.acEvo.timeOfDayMinutes": "timing.time-of-day",
  "acc.acEvo.timeOfDaySeconds": "timing.time-of-day",
...
const EXTENSION_METADATA: Record<string, Omit<ExtensionMetadata, "semanticId">> = {
  ...
  "acc.acEvo.clutchPercent": {
    unit: "ratio",
    description: "AC Evo clutch input as a ratio from fully released to fully applied.",
  },
  "acc.acEvo.currentTorque": {
    unit: "N·m",
    description: "AC Evo current engine torque in newton-metres.",
  },
  "acc.acEvo.currentBhp": {
    unit: "bhp",
    description: "AC Evo current engine power in brake horsepower.",
    kind: "normalized",
    normalization: "bhp * 745.7",
  },
  "acc.acEvo.sessionTimeLeftMs": {
    unit: "ms",
    description: "AC Evo session time remaining in milliseconds.",
    kind: "normalized",
    normalization: "milliseconds / 1000",
  },
  "acc.acEvo.deltaTimeMs": {
    unit: "ms",
    description: "AC Evo signed time delta to active reference.",
    kind: "normalized",
    normalization: "milliseconds / 1000",
  },
  "acc.acEvo.exhaustTempC": {
    unit: "°C",
    description: "AC Evo current exhaust-gas temperature.",
  },
  "acc.acEvo.gapAheadSeconds": {
    unit: "s",
    description: "AC Evo signed time gap to the vehicle directly ahead.",
  },
  "acc.acEvo.gapBehindSeconds": {
    unit: "s",
    description: "AC Evo signed time gap to the vehicle directly behind.",
  },
  "acc.acEvo.totalDrivingTimeS": {
    unit: "s",
    description: "AC Evo total driving time in seconds.",
  },
  "acc.acEvo.timeOfDayHours": {
    unit: "h",
    description: "AC Evo hour component of session time of day.",
    kind: "normalized",
    normalization: "combine time-of-day hour, minute, and second components as elapsed seconds",
  },
  "acc.acEvo.timeOfDayMinutes": {
    unit: "min",
    description: "AC Evo minute component of session time of day.",
    kind: "normalized",
    normalization: "combine time-of-day hour, minute, and second components as elapsed seconds",
  },
  "acc.acEvo.timeOfDaySeconds": {
    unit: "s",
    description: "AC Evo second component of session time of day.",
    kind: "normalized",
    normalization: "combine time-of-day hour, minute, and second components as elapsed seconds",
  },
  "acc.acEvo.handbrakePercent": {
    unit: "ratio",
    description: "AC Evo handbrake input as a ratio from fully released to fully applied.",
  },
  "acc.acEvo.fuelLiters": {
    unit: "L",
    description: "AC Evo fuel remaining in litres.",
  },
  "acc.acEvo.fuelPercent": {
    unit: "%",
    description: "AC Evo fuel remaining as a percentage of tank capacity.",
  },
  "acc.acEvo.fuelLitersUsed": {
    unit: "L",
    description: "AC Evo fuel used during the current session in litres.",
  },
  "acc.acEvo.kmPerFuelLiter": {
    unit: "km/L",
    description: "AC Evo average fuel efficiency in kilometres per litre.",
  },
  "acc.acEvo.instantaneousKmPerLiter": {
    unit: "km/L",
    description: "AC Evo instantaneous fuel efficiency in kilometres per litre.",
  },
  "f1.pitLaneTimeInLaneInMS": {
    unit: "ms",
    description: "F1 elapsed time spent in pit lane during current visit.",
    kind: "normalized",
    normalization: "milliseconds / 1000",
  },
  "f1.fuelMix": {
    unit: "enum",
    description: "F1 driver-selected engine fuel mixture.",
    kind: "normalized",
    normalization: "map F1 fuel-mixture code 0/1/2/3 to lean/standard/rich/max",
  },
  ...
  "f1.tyreBlisters": {
    unit: "%",
    description: "F1 tire blistering percentage for each wheel, FL/FR/RL/RR.",
  },
