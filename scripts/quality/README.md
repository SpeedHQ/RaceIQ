...
| `bun scripts/quality/bench-compare.ts <baseline.json> <current.json> [--threshold=5] [--fail-on-regression]` | Compare Mitata median, p99, and allocation results; optionally fail when regressions exceed threshold.                         |
