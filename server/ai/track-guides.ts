...
const guides: TrackGuide[] = [
  ...
  // Sources: https://www.formula1.com/en/latest/article/circuit-guide-everything-you-need-to-know-about-spa-francorchamps circuit character/corners; long-established F1 circuit knowledge
  {
    ...
    corners: [
      ...
      { name: "Stavelot", numbers: [15], type: "double-apex right", technique: "Late first apex, short straight, then commit to second part — exit speed is critical", trap: "Too much speed into first part compromises second apex and exit onto Courbe Paul Frère" },
      { name: "Courbe Paul Frère", numbers: [16], type: "fast flowing left", technique: "Near-flat off Stavelot's exit — minimal lift, let the car run out to track edge to set up Blanchimont", trap: "Lifting early or running wide scrubs momentum all the way through Blanchimont onto the Bus Stop straight" },
  ...
  // Sources: https://www.formula1.com/en/racing/2026/japan/circuit official F1 circuit guide; 130R/Spoon/Degner naming well documented
  {
    ...
    corners: [
      ...
      { name: "S Curves", numbers: [3, 4, 5, 6, 7], type: "fast flowing left-right-left-right-left sequence (T3-T7)", technique: "Rhythm is everything — light braking or lifts between direction changes, carry maximum speed, trust the car", trap: "Over-driving any single apex ruins the whole sequence. Smooth > aggressive here" },
      { name: "Dunlop Curve", numbers: [8], type: "medium-speed right (T8)", technique: "Moderate braking, late apex, good exit feeds Degner approach", trap: "Flat-spotting tires under heavy braking on the downhill" },
      { name: "Degner 1", numbers: [9], type: "fast right-hander (T9)", technique: "Quick direction change from Dunlop exit, commit to the speed, clip apex", trap: "Hesitation loses huge time; need trust in the car's grip" },
      { name: "Degner 2", numbers: [10], type: "tight right (T10)", technique: "Hard braking, late apex. Exit feeds the straight to the Hairpin", trap: "Carrying too much speed from Degner 1 and over-shooting" },
  ...
  // Sources: https://driver61.com/circuit-guide/brands-hatch/ Driver61 circuit guide
  {
    ...
    corners: [
      ...
      { name: "Sheene Curve", numbers: [7], type: "fast right-left (T7-T8)", technique: "Smooth direction changes at speed, carry momentum through both parts", trap: "Over-driving causes snap on direction change" },
      { name: "Clark Curve", numbers: [9], type: "fast left leading to Paddock Hill (T9)", technique: "Clean exit onto start/finish straight — exit speed is critical", trap: "Running wide loses speed all the way down the pit straight" },
    ],
  ...
  // Sources: https://www.formula1.com/en/racing/2026/germany/circuit historical F1 GP-circuit corner naming (Castrol-S, Mercedes Arena, Dunlop Kehre, Schumacher S, Veedol, NGK)
  {
    ...
    corners: [
      ...
      { name: "Mercedes Arena", numbers: [2, 3], type: "technical left-left-right sequence (T2-T4)", technique: "T2: dab brake at grey kerbing ref, 2nd gear. Stick to inside through T3 as it tightens. T4: flick in early, short-shift to 2nd", trap: "T3 keeps tightening — running wide here ruins T4 exit onto the straight" },
      ...
      { name: "Dunlop Kehre", numbers: [7], type: "downhill right hairpin (T7)", technique: "Tricky braking — no clear reference point. Trail brake to early first apex, coast, then get on power for second apex", trap: "Misjudging the downhill braking zone; no reference markers make this consistently tricky" },
      { name: "Schumacher S", numbers: [8, 9], type: "fast left-right (T8-T9)", technique: "High-speed commitment, smooth direction change. Carry speed through both parts", trap: "Fighting the car with corrections instead of flowing through" },
      ...
      { name: "Bit-Kurve", numbers: [12], type: "fast right (T12)", technique: "Flat-out right-hand kink, stay smooth", trap: "Unnecessary lifting" },
      { name: "Veedol", numbers: [13, 14], type: "fast left-right chicane (T13-T14)", technique: "Brake between 100m and 50m, 3rd gear. Cut inside kerb T13, smash inside kerb T14 (if ride height allows)", trap: "Hitting concrete block on T13 kerb unsettles the car" },
      { name: "Coca-Cola Kurve", numbers: [15], type: "final right hairpin (T15)", technique: "Hard braking, tight hairpin. Clean exit onto start/finish straight", trap: "Braking too late and missing the apex; poor exit costs pit straight speed" },
    ],
    priorityCorners: ["Castrol-S", "Dunlop Kehre", "Veedol", "Coca-Cola Kurve"],
  },
