 ...
 * driven. See `server/ai/arm-stream.ts`.
 *
...
import { computeLapConsistencyDelta, LINE_SPREAD_FULL_SCALE_M } from "../lap-consistency";
...
export type InputChannel = "brake" | "throttle";
 ...
 * one lap at a time instead (`server/ai/arm-stream.ts`); both must agree, and
