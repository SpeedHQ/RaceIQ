...
export interface ArmSummary {
   ...
   * `FRAME_BUDGET_PER_ARM` in `server/experiments/comparison/stream.ts`). Always 0 for a
 ...
 * one by folding laps past a reference (`server/experiments/comparison/stream.ts`). Both then go
