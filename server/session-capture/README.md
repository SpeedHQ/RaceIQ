...
- Compression and manual telemetry cleanup share the maintenance lock across candidate discovery and file/database changes. Orphan cleanup acquires the same lock per file.
- Reprocessing preserves favourites on matched replacement laps, keeping their captures protected from manual telemetry cleanup.
