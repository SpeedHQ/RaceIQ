...
export const migrations: { version: number; name: string; sql: string[] }[] = [
  ...
  // v65: Persist canonical participant runs, independent stint dimensions,
  ...
  // v67: Durable canonical telemetry archive identity, hierarchy, and jobs.
  {
    version: 67,
  ...
  // v69: Persist deterministic structured findings and finding-generation cache fences.
  {
    version: 69,
  ...
  // v70: Preserve ordered A/B identity for comparison analysis cache rows.
  {
    version: 70,
    name: "preserve directional comparison analysis caches",
    sql: [
      `CREATE TABLE compare_analyses_v70 (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        lap_a_id INTEGER NOT NULL,
        lap_b_id INTEGER NOT NULL,
      ...
      `INSERT INTO compare_analyses_v70 (
      ...
      `ALTER TABLE compare_analyses_v70 RENAME TO compare_analyses`,
