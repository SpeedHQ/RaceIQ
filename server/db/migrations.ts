...
export const migrations: { version: number; name: string; sql: string[] }[] = [
  ...
  // v64: Persist canonical participant runs, independent stint dimensions,
  ...
  // v65: Persist immutable provenance receipts and one active generation per
  ...
  // v66: Durable canonical telemetry archive identity, hierarchy, and jobs.
  {
    version: 66,
