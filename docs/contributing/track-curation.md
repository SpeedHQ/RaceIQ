...
- ACC tracks whose curated centerline CSV still follows the fastlane racing line (issue #98); bundled SVG already supplies a geometric centre for boundary views, while corner rosters require separate per-track re-curation.
