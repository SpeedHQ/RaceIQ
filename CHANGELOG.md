...
- Import ACC and Assetto Corsa Evo MoTeC `.ld`/`.ldx` logs or ZIP bundles as replayable laps with reconstructed racing lines, canonical telemetry, setup/ownership metadata, and explicit source limitations
