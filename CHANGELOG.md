...
### Internal
- Run pull-request E2E suites with shared setup, sequential light batches, and three isolated seeded shards so Chromium installs once without sharing mutable test state
