...
import { SEEDED_GAME_CASES, SEEDED_GLOBAL_ROUTE_CASES, SEEDED_ROUTE_CASES, type SeededFeature } from "../../support/seeded/cases";
import { collectBrowserErrors } from "../../support/browser-errors";
import { assertNoHorizontalOverflow } from "../../support/responsive/assertions";

const ROUTE_ERROR_TEXT = [/desktop required/i, /\bnot found\b/i, /\broute error\b/i];
...
for (const game of SEEDED_GAME_CASES.filter(({ unsupportedFeatures }) => unsupportedFeatures.length > 0)) {
