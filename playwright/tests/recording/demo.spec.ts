...
test("record demo render", async ({ page }, testInfo) => {
  ...
  await page.evaluate(() => {
    ...
    container.style.cssText = ["position:fixed", "inset:0", "width:100vw", "height:100vh", "z-index:9999", "background:black", "border-radius:0", "border:none", "overflow:hidden"].join(";");
  });
