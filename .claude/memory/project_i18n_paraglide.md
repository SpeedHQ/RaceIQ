...
**Scope:** infra + AI-output localization is complete; UI string extraction is partial (wizard, settings, nav only) — rest of UI stays English and migrates incrementally.
