    ...
    return (
      <div
        ...
        className={cn(
          ...
          "group-data-[variant=muted]/reasoning-root:bg-[linear-gradient(to_bottom,color-mix(in_srgb,var(--muted)_50%,transparent),transparent)]",
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "group-data-[variant=muted]/reasoning-root:bg-[linear-gradient(to_top,color-mix(in_srgb,var(--muted)_50%,transparent),transparent)]",
        "fade-in-0 animate-in",
        "duration-(--animation-duration)",
        className,
      )}
