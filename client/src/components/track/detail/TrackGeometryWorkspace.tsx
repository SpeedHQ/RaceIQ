...
export function TrackGeometryWorkspace({ model, mode, layers, onLayerChange }: TrackGeometryWorkspaceProps) {
  ...
  return (
    <div data-geometry-mode={mode} className="flex min-h-0 flex-col gap-3 @7xl/workspace:grid @7xl/workspace:grid-cols-[minmax(0,1fr)_20rem]">
      ...
      <TrackDebugSidebar
        ...
        setEditing={(editing) => (editing ? model.startEditing() : model.cancelEditing())}
