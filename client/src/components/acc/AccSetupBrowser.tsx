      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {fileUrl ? (
          <a
            ...
            className="text-app-compact uppercase tracking-wide px-4 py-2 rounded border border-app-border text-app-text-secondary hover:text-app-text no-underline inline-flex items-center gap-1.5"
          >
          ...
          ytVideoId &&
          ytLoading && (
            <span className="text-app-compact uppercase tracking-wide px-4 py-2 rounded border border-app-border text-app-text-muted inline-flex items-center gap-1.5 cursor-wait" aria-busy="true">
        ...
        {videoUrl && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-app-compact uppercase tracking-wide px-4 py-2 rounded border border-app-border text-status-danger hover:text-status-danger/80 no-underline"
          >
            ▶ {m.browser_video()}
          </a>
        )}
        {setup.pageUrl && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-app-compact uppercase tracking-wide px-4 py-2 rounded border border-app-border text-app-text-muted hover:text-app-text no-underline"
          >
            {m.browser_source()}
          </a>
        )}
