      ...
      <div className="grid grid-cols-3 gap-3">
        {wheels.map((w) => (
          <Button
            ...
            className={`relative rounded-lg border p-3 text-left transition-all ${wheelStyle === w.src ? "border-app-accent bg-app-accent/10 ring-1 ring-app-accent/30" : "border-app-border bg-app-surface-alt hover:border-app-border-hover"}`}
          >
