      ...
      {telemetry.length > 0 && (
        <AnalyseWorkspacePanels
          topSectionProps={{
            ...
            segments,
            trackImagery,
            geographicPositions: semanticReplay?.geographicPositions ?? null,
            showTrackImagery,
          ...
          dataPanelProps={{
            ...
            currentFrame,
            startFuel: telemetry[0] ? {
              remainingVolumeL: semanticNumber(telemetry[0], "fuel.remaining-volume") ?? undefined,
              remainingFraction: semanticNumber(telemetry[0], "fuel.remaining-fraction") ?? undefined,
            } : undefined,
            gameId,
            units,
            wearRate,
