...
export function AnalyseAiSidebar({ lapId, gameId, qualityStateKey, carName, trackName, segments, aiPanelRef, onJumpToFrac, onHighlightsChange }: AnalyseAiSidebarProps) {
  return (
