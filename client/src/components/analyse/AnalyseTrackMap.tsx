...
export const AnalyseTrackMap = forwardRef<TrackMapHandle, TrackMapProps>(function AnalyseTrackMap(props, ref) {
  const { gameId, telemetry, cursorIdx, outline, mapLabels, pitRoad, boundaries, sectors, segments, highlights, showInputs, showTrace = true, rotateWithCar, zoom = 1 } = props;
  ...
  }, [gameId, telemetry, resolvedPositions, outline, mapLabels, pitRoad, boundaries, sectors, segments, highlights, showInputs, showTrace, rotateWithCar, zoom]);
