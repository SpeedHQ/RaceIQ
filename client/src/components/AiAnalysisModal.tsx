                ...
                <section>
                  ...
                  <div className="grid grid-cols-1 gap-1.5">
                    {analysis.tuning.map((item, i) => (
                      <div key={i} className="flex items-center gap-3 bg-slate-800/40 border border-slate-700/40 rounded-lg px-3.5 py-2">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                          ...
                          <span className="text-xs font-mono text-amber-300 font-semibold">{item.target}</span>
                        </div>
                      </div>
                    ))}
                  </div>
