...
function TabsTrigger({ className, variant = "default", ...props }: TabsTriggerProps) {
  const variants = {
    default:
      "rounded-md px-3 py-1.5 text-xs font-semibold text-app-text-muted transition-colors outline-none hover:bg-app-surface-hover hover:text-app-text data-[active]:bg-app-accent/20 data-[active]:text-app-accent",
