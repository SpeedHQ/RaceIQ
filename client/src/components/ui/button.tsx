...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-app-subtext font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        "settings-nav":
          "shrink-0 md:w-full !justify-start !rounded-none !px-4 !py-2 text-app-subtext whitespace-nowrap transition-colors text-app-text-muted hover:text-app-text hover:bg-app-surface-hover",
        "settings-nav-selected":
          "shrink-0 md:w-full !justify-start !rounded-none !px-4 !py-2 text-app-subtext whitespace-nowrap transition-colors text-app-accent bg-app-accent/10 border-b-2 md:border-b-0 md:border-r-2 border-app-accent",
        ...
        "search-select-trigger":
          "rounded border border-app-border-input px-3 py-2 text-app-subtext text-app-text-secondary outline-none transition-colors hover:text-app-text focus-visible:border-app-accent focus-visible:ring-1 focus-visible:ring-app-accent/30 md:px-2 md:py-0.5 md:text-app-compact",
        ...
        "focus-toggle": "!rounded-none text-app-label transition-colors text-app-text-dim hover:text-app-text hover:bg-app-surface-hover/30",
        "focus-toggle-driver": "!rounded-none text-app-label transition-colors bg-(--focus-driver)/20 text-(--focus-driver) font-semibold",
        "focus-toggle-setup": "!rounded-none text-app-label transition-colors bg-(--focus-setup)/20 text-(--focus-setup) font-semibold",
      },
      size: {
        default: "h-8 gap-1.5 px-2.5 has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2",
        xs: "h-6 gap-1 rounded-[min(var(--radius-md),10px)] px-2 text-app-label in-data-[slot=button-group]:rounded-lg has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 [&_svg:not([class*='size-'])]:size-3",
        ...
        "app-sm": "px-2 py-0.5 text-app-label gap-1 [&_svg:not([class*='size-'])]:size-3",
        "app-md": "px-3 py-1.5 text-app-label gap-1.5",
        "app-lg": "px-4 py-2 text-app-subtext gap-1.5",
