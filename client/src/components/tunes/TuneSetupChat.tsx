 ...
 */
async function fetchTuneChatHistory(sessionId: number, gen?: number) {
  const msgs = await fetchChatHistory(`/api/experiments/${sessionId}/chat`, gen);
