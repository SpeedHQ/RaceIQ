...
import { hasTireHealthDataSemantic, resolveAnalysisTelemetry } from "@shared/racing/analysis/telemetry-capabilities";
      ...
      <div className="space-y-3">
        ...
        <div className="py-1">
          ...
          <div className="flex items-center gap-3">
            {fuel === undefined || fuelPct === undefined ? (
            ...
            <div className={`text-2xl font-mono font-black tabular-nums leading-none ${fuel?.unit === "L" ? "w-20" : "w-14"} text-right`} style={{ color: fuelColor }}>
              {fuel === undefined ? "—" : `${fuel.amount.toFixed(fuel.unit === "L" ? 1 : 0)}${fuel.unit}`}
            </div>
          </div>
        </div>
