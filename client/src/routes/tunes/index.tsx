      ...
      <div className="space-y-2">
        {isLoading ? (
          ...
          <div className="text-center py-12 text-app-text-muted text-sm">
            ...
            <p className="mt-1">Create a new tune or <Link to="/tunes/catalog" className="text-app-accent hover:underline">clone one from the catalog</Link>.</p>
          </div>
        ) : (
          filteredUserTunes.map((tune) => (
            <UserTuneCard
              ...
              onEdit={() => navigate({ to: `/tunes/edit/${tune.id}` })}
