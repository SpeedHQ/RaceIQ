        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="p-4 space-y-3">
            <div className="grid grid-cols-2 gap-3">
              ...
              <label className="space-y-1">
                <span className="text-xs font-medium text-app-text-muted">Car Ordinal</span>
                <input type="number" value={carOrdinal} onChange={(e) => setCarOrdinal(parseInt(e.target.value) || 0)} required className="w-full bg-app-bg/85 border border-app-border rounded px-2 py-1.5 text-sm text-app-text font-mono focus:outline-none focus:ring-1 focus:ring-app-accent" />
              </label>
              <label className="space-y-1">
