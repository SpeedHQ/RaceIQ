...
export const Route = createFileRoute("/acc/experiments/$experimentId_/review")({
...
function RouteComponent() {
  ...
  return <TestReviewPage gameId="acc" experimentId={Number(experimentId)} lapIds={lapIds} versionId={versionId} />;
}
