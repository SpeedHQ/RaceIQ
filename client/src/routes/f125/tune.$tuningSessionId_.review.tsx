...
export const Route = createFileRoute("/f125/tune/$tuningSessionId_/review")({
...
function RouteComponent() {
  ...
  return <TestReviewPage gameId="f1-2025" tuningSessionId={Number(tuningSessionId)} lapIds={lapIds} />;
}
