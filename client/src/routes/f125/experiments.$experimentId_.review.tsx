...
export const Route = createFileRoute("/f125/experiments/$experimentId_/review")({
...
function RouteComponent() {
  ...
  return <TestReviewPage gameId="f1-2025" experimentId={Number(experimentId)} lapIds={lapIds} versionId={versionId} />;
}
