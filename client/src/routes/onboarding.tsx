...
const STEPS = [
  ...
  { path: "/onboarding/connection", label: "Connection" },
] as const;
...
function OnboardingLayout() {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-app-bg p-4">
      <div className="w-full max-w-2xl rounded-xl border border-app-border bg-app-surface shadow-2xl overflow-hidden">
