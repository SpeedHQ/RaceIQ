...
export interface LiveTelemetryView {
 ...
 damage:{frontLeftWingPct?:number; frontRightWingPct?:number; rearWingPct?:number; floorPct?:number; diffuserPct?:number; sidepodPct?:number}; race:{ isRaceOn?: boolean }; competitors: readonly LiveCompetitorView[]; f1?: LiveF1Extension; stateBySemanticId: Readonly<Record<string, ResolutionState>>;
}
...
export function buildLiveTelemetryView(schema: LiveTelemetrySchemaMessageV1, frame: LiveTelemetryFrameMessageV1): LiveTelemetryView | undefined {
 ...
 const grouped:any={identity:{},motion:{},inputs:{},engine:{},fuel:{},timing:{},tires:{},weather:{},aero:{},ers:{},damage:{},race:{},competitors:[],stateBySemanticId:{}};
 ...
 put(grouped.race,"isRaceOn","race.is-race-on");
