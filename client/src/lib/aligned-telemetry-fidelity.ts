...
function cropTrace(t: AlignedLapTrace, first: number, last: number): AlignedLapTrace {
  ...
  return {
    ...
    speedMps: sliceF32(t.speedMps, first, last), throttle: sliceF32(t.throttle, first, last), brake: sliceF32(t.brake, first, last), steer: sliceF32(t.steer, first, last), rpm: sliceF32(t.rpm, first, last), gear: sliceU8(t.gear, first, last), positionX: sliceF32(t.positionX, first, last), positionZ: sliceF32(t.positionZ, first, last), yaw: sliceF32(t.yaw, first, last), elapsedTimeS: sliceF32(t.elapsedTimeS, first, last), fuel: sliceF32(t.fuel, first, last), tireWear: t.tireWear ? sliceF32(t.tireWear, first, last) : null,
