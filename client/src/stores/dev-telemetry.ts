...
export interface DevTelemetryActions extends StoreActionMap {
...
export function useDevTelemetryStore<T>(selector: (state: DevTelemetryState) => T): T {
  return useSelector(devTelemetryStore, selector, { compare: Object.is });
}
