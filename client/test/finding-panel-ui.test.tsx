...
function finding(overrides: Partial<FindingRecord> = {}): FindingRecord {
  return {
    ...
    category: "driving",
    scope: { kind: "lap", sessionId: "session-1", lapId: "17" },
    status: "available",
    severity: "medium",
    confidence: "high",
    measurements: [],
...
describe("FindingPanel", () => {
      ...
      createElement(FindingPanel, {
        findings: [finding({
          ...
          evidenceRefs: [
            ...
            { kind: "telemetry-range", id: "event-1", startFrameIndex: 12, endFrameIndex: 18, channel: "inputs.brake" },
            { kind: "telemetry-range", id: "event-2", startFrameIndex: 31, endFrameIndex: 31, channel: "inputs.brake" },
          ],
    ...
    const markup = renderToStaticMarkup(createElement(FindingPanel, {
      findings: [finding({
        comparisonReference: {
          ...
          evidenceRefs: [{ kind: "telemetry-range", id: "reference-range", startFrameIndex: 20, endFrameIndex: 35 }],
        },
      })],
      onJumpToFrame: () => {},
    }));
  ...
  test("renders evidence-backed empty state", () => {
    const markup = renderToStaticMarkup(createElement(FindingPanel, { findings: [], onJumpToFrame: () => {} }));
