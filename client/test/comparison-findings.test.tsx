...
const serverFinding: FindingRecord = {
  ...
  category: "pace",
  scope: { kind: "comparison", sessionId: "7", cornerId: "Turn 1" },
  status: "available",
  severity: "medium",
  confidence: "high",
  measurements: [{
  ...
  evidenceRefs: [
    { kind: "telemetry-range", id: "range:41:Turn 1:0:comparison-a", sessionId: "7", startFrameIndex: 12, endFrameIndex: 18 },
    { kind: "telemetry-range", id: "range:52:Turn 1:0:comparison-b", sessionId: "9", startFrameIndex: 20, endFrameIndex: 27 },
  ],
  qualityRefs: [],
  limitations: [],
