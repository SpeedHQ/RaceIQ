...
export function encodeAlignedLapSet(set: AlignedLapSet): EncodedAlignedLapSet {
  return {
    ...
    laps: set.laps.map((t): EncodedAlignedLapTrace => ({
      ...
      tireWear: f(t.tireWear), tireTemp: encodeWheel(t.tireTemp), tirePressure: encodeWheel(t.tirePressure), brakeTemp: encodeWheel(t.brakeTemp), suspTravel: encodeWheel(t.suspTravel), combinedSlip: encodeWheel(t.combinedSlip), balanceDeg: f(t.balanceDeg), latG: f(t.latG), longG: f(t.longG), tireAverages: t.tireAverages, pressureAverages: t.pressureAverages, brakeTempAverages: t.brakeTempAverages,
    })),
  };
}
export function decodeAlignedLapSet(e: EncodedAlignedLapSet): AlignedLapSet {
  ...
  return {
    ...
    laps: e.laps.map((t): AlignedLapTrace => ({
      ...
      sourceIndices: base64ToU32(t.sourceIndices), speedMps: base64ToF32(t.speedMps), throttle: base64ToF32(t.throttle), brake: base64ToF32(t.brake), steer: base64ToF32(t.steer), rpm: base64ToF32(t.rpm), gear: base64ToU8(t.gear), positionX: base64ToF32(t.positionX), positionZ: base64ToF32(t.positionZ), yaw: base64ToF32(t.yaw), elapsedTimeS: base64ToF32(t.elapsedTimeS), fuel: base64ToF32(t.fuel), tireWear: d(t.tireWear), tireTemp: decodeWheel(t.tireTemp), tirePressure: decodeWheel(t.tirePressure), brakeTemp: decodeWheel(t.brakeTemp), suspTravel: decodeWheel(t.suspTravel), combinedSlip: decodeWheel(t.combinedSlip), balanceDeg: d(t.balanceDeg), latG: d(t.latG), longG: d(t.longG), tireAverages: t.tireAverages, pressureAverages: t.pressureAverages, brakeTempAverages: t.brakeTempAverages,
    })),
  };
}
