...
export interface AlignedLapTrace {
  ...
  tireCoreTemp: WheelTrace<Float32Array> | null;
  tireCarcassTemp: WheelTrace<Float32Array> | null;
...
export interface EncodedAlignedLapTrace {
  ...
  tireCoreTemp: EncodedWheelTrace | null;
  tireCarcassTemp: EncodedWheelTrace | null;
