...
import { bundledGeometryPath, bundledSharedGeometryPath, getTrackAssetIdentity, sharedAccGeometrySlug, usesAccGeometryFallback, type TrackAssetIdentity } from "../storage/assets";
