/**
 * Loader for the authored expert track guides in shared/data/tracks/guides/.
 *
 * Uses the same platform/runtime/data-paths SHARED_DIR resolution as track storage, so
 ...
 *
 * Locale overlays (shared/data/tracks/guides-<locale>/) are read here but not yet
 ...
 * shared/racing/tracks/curation/segment-align-validate.ts — this repo validates committed track data with
