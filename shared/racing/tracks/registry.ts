...
/** Generated SQLite track registry schema version. */
...
/** Open validated singleton registry for read queries. */
export function getTrackRegistry(): Database {
  return openTrackRegistry(true);
}

/** Run development-only generated-registry write transaction and invalidate dependent caches. */
...
/** Monotonic in-process revision used to invalidate registry-backed caches. */
export function getTrackRegistryRevision(): number {
  return registryRevision;
}

/** Close singleton registry so later access reopens and revalidates artifact. */
