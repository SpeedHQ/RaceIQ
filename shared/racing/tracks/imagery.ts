...
/** Valid WGS84 latitude and longitude pair. */
...
/** Non-wrapping geographic rectangle with positive area. */
...
/** Affine mapping from normalized image coordinates to local east/north metres. */
...
/** Comparable source candidate with quality, legal, stability, and resolution metadata. */
...
/** Estimated dimensions, tile count, storage, and duration for one imagery output. */
...
/** Resource-safety decision and limits attached to output estimate. */
...
/** Selected source candidate paired with its resource budget. */
...
/** iRacing-backed geographic reference used to calibrate another game track. */
...
/** Remote immutable imagery pack declaration verified by size and SHA-256. */
...
/** Venue-shared base imagery, affine calibration, and optional overlay layers. */
...
/** Per-game layout selection of venue overlay layer IDs. */
...
/** Attribution and provenance attached to one imagery layer. */
export type TrackImagerySource = z.infer<typeof imageSourceSchema>;
/** Semantic role controlling overlay composition order. */
export type TrackImageryLayerKind = TrackImageryVenueManifest["layers"][number]["kind"];

/** Runtime overlay texture exposed to client. */
...
/** Runtime HQ base tile grid and source metadata. */
...
/** Complete runtime imagery payload for one canonical venue and game layout. */
...
/** Local planar point using game X/Z axes or normalized image U/V inputs. */
...
/** Project WGS84 point into calibration's local east/north frame. */
...
/** Convert local east/north metres back to WGS84 around supplied origin. */
...
/** Compose affine transforms so inner mapping runs before outer mapping. */
...
/** Apply affine image-to-track transform to one point. */
...
/** Translate affine transform in local track X/Z space. */
...
/** Scale affine transform around normalized image center. */
...
/** Rotate affine transform around normalized image center. */
