...
- Uses `GameAdapter` and `AnalysisTelemetryModel` from `../games/types.ts`.
- Client analysis panels import `shared/analysis/telemetry-capabilities` directly (`client/src/components/analyse/*`).
