...
- Do not place simulator setup files here; ACC/AC Evo file contracts and form schema live in `shared/racing/setups/`.
...
```ts
import fanatec15Nm from "@shared/data/setup/fanatec-15nm.json";
```
