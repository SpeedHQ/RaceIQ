...
export const LIVE_GAME_SEMANTIC_IDS = {
  ...
  acc: ["damage.brake-pad-wear", "race.pit-status", "tire.temperature.core", "tire.temperature.surface.inner", "tire.temperature.surface.middle", "tire.temperature.surface.outer", "tire.temperature.surface.representative", "tires.tire-compound-name", "tires.tire-radius"],
