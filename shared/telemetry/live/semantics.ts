...
export const LIVE_ENGINEER_REQUIRED_SEMANTIC_IDS = [
...
export function liveEngineerRequiredSemanticIds(_gameId: GameId): readonly string[] {
  return LIVE_ENGINEER_REQUIRED_SEMANTIC_IDS;
}
