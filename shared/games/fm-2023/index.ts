...
export const forzaAdapter: GameAdapter = {
  ...
  routePrefix: "fm23",
  telemetry: {
    fuel: { packetUnit: "fraction", binding: { kind: "value", semanticId: "fuel.remaining-fraction" } },
    ...
    handBrake: { source: "direct", freshness: "continuous", binding: { kind: "value", semanticId: "inputs.handbrake" } },
    analysis: {
