...
export const accAdapter: GameAdapter = {
  ...
  telemetry: {
    ...
    tireSurfaceProfile: { source: "direct", freshness: "continuous", binding: { kind: "group", required: ["tire.temperature.surface.inner", "tire.temperature.surface.middle", "tire.temperature.surface.outer"] } },
