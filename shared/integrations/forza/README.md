...
`shared/integrations/forza/internal/lzx-engine` -> `shared/integrations/forza/lzx-decoder` -> `server/games/fm-2023/extraction`

`shared/integrations/forza/install` + `shared/integrations/forza/zip` -> `server/games/fm-2023/extraction`
...
- Import explicit leaf modules such as `shared/integrations/forza/zip`; do not add a barrel.
